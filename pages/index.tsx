          ...
          <div className={step !== 3 ? ' opacity-30' : ''}>
            ...
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
              ...
              <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row items-center px-3 py-2 border-t dark:border-gray-600">
                <button
                  disabled={
                    step !== 3 || signed || !!(twitterUser && twitterUser.tweet)
                  }
        ...
        <li className="ml-4">
          ...
          <div className={step !== 4 ? 'hidden' : ''}>
            ...
            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
              ...
              ready to play Stanks. We invite you to join our Discord community
              to stay up-to-date on official announcements and to connect with
