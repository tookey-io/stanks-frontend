...
const AuthPage = observer(() => {
  ...
  return (
    <>
      <Head>
        <title>Stanks join</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon-32x32.png" />
      </Head>
      <div className="max-w-xl justify-center m-auto mt-10 mb-10">
        <h2 className="text-3xl font-extrabold dark:text-white mb-8">
          To{' '}
          <span className="text-blue-600 dark:text-blue-500">join Stanks</span>{' '}
          ...
          <li className="mb-6 ml-4">
            ...
            <div className={step !== 1 ? ' opacity-30' : ''}>
              ...
              <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                technology and collect your Bitcoin rewards. To learn more{' '}
                <a
              ...
              <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                  ...
                  <textarea
                    ...
                    id="comment"
                    rows={3}
                    className="w-full px-0 text-xl text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 focus:outline-0 dark:text-white dark:placeholder-gray-400 resize-none"
                    required
                    value={tweet}
                ...
                <div className="flex items-center px-3 py-2 border-t dark:border-gray-600">
                  <button
                    ...
                    className="inline-flex text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 disabled:from-gray-600 disabled:via-gray-600 disabled:to-gray-600 disabled:dark:shadow-none disabled:cursor-not-allowed disabled:opacity-50"
                    onClick={onSign}
                  >
                    {signed ? '1. Signed' : '1. Sign Message'}
                    <svg
                  ...
                  <button
                    disabled={step !== 3 || !signed}
                    className="inline-flex text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 shadow-lg shadow-purple-500/50 dark:shadow-lg dark:shadow-purple-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 disabled:from-gray-600 disabled:via-gray-600 disabled:to-gray-600 disabled:dark:shadow-none disabled:cursor-not-allowed disabled:opacity-50"
                    onClick={onTweet}
                  >
                    2. Tweet
                    <svg
            ...
            <div className={step !== 4 ? 'hidden' : ''}>
              ...
              <div className="flex">
                <button
                  disabled
                  type="button"
                  className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:cursor-not-allowed disabled:opacity-50 mr-2 mb-2"
                >
                  Play Stanks!
                </button>
                <a
                  className="text-white bg-[#7289da] hover:bg-[#7289da]/90 focus:ring-4 focus:outline-none focus:ring-[#7289da]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#7289da]/55 mr-2 mb-2"
